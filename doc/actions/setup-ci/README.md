...
|          <a name="input_operating-system"></a>[operating-system](#input_operating-system)          | string |  false   |         `"[\"ubuntu-latest\"]"`          |                                        Json formatted list of OS <br>used for building a release. <br>E.g. ["ubuntu-latest", "macos-latest"]                                         |
...
|    <a name="input_python-minor-version"></a>[python-minor-version](#input_python-minor-version)    | string |  false   |                 `"[13]"`                 |                                          Json formatted list of python <br>minor versions used for building <br>a release. eg. "[10, 11]"                                            |
...
|---------------------------------------------------------------------------------|--------|--------------------------------------------------------------------------------------------------------------------------------------|
|           <a name="output_build_os"></a>[build_os](#output_build_os)            | string |                                 Json formatted list of OS <br>to build on given the <br>input event                                  |
|           <a name="output_build_py"></a>[build_py](#output_build_py)            | string |                        Json formated list of python <br>minor versions to build on <br>given the input event                         |
...
|        <a name="output_highest_py"></a>[highest_py](#output_highest_py)         | string |                                         highest python minor version used <br>for a release                                          |
