...
|          <a name="input_operating-system"></a>[operating-system](#input_operating-system)          | string  |  false   | `"[\"ubuntu-latest\", \"macos-latest\", \"macos-15-intel\", \"windows-latest\"]"` |                                                              Json formatted list of OS <br>used for building a release. <br>E.g. ["ubuntu-latest", "macos-latest"]                                                                |
...
|    <a name="input_python-minor-version"></a>[python-minor-version](#input_python-minor-version)    | string  |  false   |                               `"[10, 11, 12, 13]"`                                |                                                                 Json formatted list of python <br>minor versions used for building <br>a release. eg. "[10, 11]"                                                                  |
